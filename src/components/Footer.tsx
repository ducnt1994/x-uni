          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center">
                ...
                <span className="text-gray-400">123 Đường ABC, Quận XYZ, TP.HCM</span>
              </li>
              <li className="flex items-center">
                <svg className="w-5 h-5 mr-3 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                </svg>
                <a href="mailto:info@educenter.com" className="text-gray-400 hover:text-blue-600 transition-colors">
                  info@educenter.com
                </a>
              </li>
              <li className="flex items-center">
                ...
                <a href="tel:+84123456789" className="text-gray-400 hover:text-blue-600 transition-colors">
                  (84) 123 456 789
                </a>
              </li>
            </ul>
